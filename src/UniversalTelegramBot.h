...
public:
  ...
  bool banChatMember(const String& chat_id, const String& user_id, int until_date = 0, bool revoke_messages = false);
  bool unbanChatMember(const String& chat_id, const String& user_id, bool only_if_banned = true);
  ...
  TelegramUpdate updates[HANDLE_UPDATES];
  long last_update_received;
  String name;
  String userName;
  int longPoll = 0;
...
private:
  ...
  bool processResult(JsonObject result, int updateIndex);
};
